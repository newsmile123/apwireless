<?php
session_start();
$_SESSION['demo']['aad']['fc'] = "Frame Control";
$_SESSION['demo']['aad']['a1'] = "Address 1";
$_SESSION['demo']['aad']['a2'] = "Address 2";
$_SESSION['demo']['aad']['a3'] = "Address 3";
$_SESSION['demo']['aad']['sc'] = "Sequence Control";
$_SESSION['demo']['aad']['a4'] = "Address 4";
$_SESSION['demo']['aad']['qos'] = "QoS Control";
?>
...
<div id="params">
	...
	<div id="aad">
        ...
        <button id="input-aad" title="Сформировать" onClick="aad()">Сформировать</button>
        </div>
	</div>
	<div id="nonce">
    	<div class="description">Формирование Nonce
        <button id="input-nonce" title="Сформировать" onClick="nonce()">Сформировать</button>
        </div>
	</div>
    <div id="key">
        <table>
        <tr><td>Key</td><td> = </td><td><input name="cipherkey" id="cipherkey" size="43" value=""/></td></tr></table>
	</div>
