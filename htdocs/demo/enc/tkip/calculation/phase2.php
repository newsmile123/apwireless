...
// Конец шага 3
$_SESSION['demo']['tkip']['var'] = "1";
$_SESSION["demo"]["tkip"]["seed"] = $wepSeed;
$_SESSION['demo']['tkip']['wep']["key"] = substr(implode(" ", $_SESSION["demo"]["tkip"]["seed"]), 6, 32);
$_SESSION['demo']['tkip']['wep']["iv"] = substr(implode(" ", $_SESSION["demo"]["tkip"]["seed"]), 0, 6);
