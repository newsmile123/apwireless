...
$ttak = $_SESSION['demo']['tkip']['phase1']['ttak'];
$tsc16 = $_SESSION['demo']['tkip']['tsc16'];
...
$_SESSION["demo"]["tkip"]["phase2"]["seed"] = implode(" ", $wepSeed);
$_SESSION['demo']['tkip']['wep']["key"] = substr(trim($_SESSION['demo']['tkip']['phase2']['seed']), 6, 32);
$_SESSION['demo']['tkip']['wep']["iv"] = substr(trim($_SESSION['demo']['tkip']['phase2']['seed']), 0, 6);
$input = array(
   'seed' => $_SESSION["demo"]["tkip"]["phase2"]["seed"],
