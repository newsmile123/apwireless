...
$mk = implode(" ", $_SESSION['demo']['tkip']['michael_key']);
$mk = str_split($mk, 8);
$_SESSION['michael']['enc']['mk'] = $mk; // 64-битный Ключ для вычисления MIC в виде 2-ух 32-битных слов
