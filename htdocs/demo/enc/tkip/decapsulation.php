...
<div id="d-calcs">
	...
	<div class="description">Phase 1 key mixing function</div>
    	<table><form id="phase1_form" action="calculation/dec/phase1.php" method="post">
           ...
           <tr><td>TTAK</td><td> = </td><td><input name="ph1_ttak" id="ph1_ttak" size="53"  value="<?=(isset($_SESSION['demo']['2']['tkip']['ttak'])?implode(" ", $_SESSION['demo']['2']['tkip']['ttak']):'')?>"/></td></tr>
        </table></form>
    </div>
    <div id="d-phase2">
    <div class="description">Phase 2 key mixing function</div>
    	<table><form id="phase2_form" action="calculation/dec/phase2.php" method="post">
    ...
    <tr><td>TTAK</td><td> = </td><td><input name="ph2_ttak" id="ph2_ttak" size="53" value="<?=(isset($_SESSION['demo']['2']['tkip']['ttak'])?implode(" ", $_SESSION['demo']['2']['tkip']['ttak']):'')?>"/></td></tr>
    <tr><td></td><td></td><td align="center"><button id="computePhase2" title="Рассчитать">Рассчитать</button></td></tr>
    <tr><td align="left">Seed</td><td> = </td><td align="center"><input name="seed" size="53" id="seed" value="<?=(isset($_SESSION['demo']['2']['tkip']['seed'])?implode(" ", $_SESSION['demo']['2']['tkip']['seed']):'')?>"/></td></tr></form>
    </table>
    </div>
</div>
<div id="d-packet">
	...
	<div class="description">RC4 Encryption</div>
    	<table><form id="rc4_form" action="calculation/decryption.php" method="post">
    		<tr><td width="110">WEP IV</td><td> = </td><td><input name="wep_iv" id="wep_iv" size="35" value="<?=(isset($_SESSION['demo']['2']['tkip']['wep']["iv"])?$_SESSION['demo']['2']['tkip']['wep']["iv"]:'')?>"/></td></tr>
    		<tr><td>ARC4 Key</td><td> = </td><td><input name="arc4_key" id="arc4_key" size="35" value="<?=(isset($_SESSION['demo']['2']['tkip']['wep']["key"])?$_SESSION['demo']['2']['tkip']['wep']["key"]:'')?>"/></td></tr>
    		<tr><td></td><td></td><td align="center"><button id="computeWep" title="Выполнить">Рассчитать</button></td></tr>
    	</table></form>
    </div>
    <div id="d-michael">
    <div class="description">MIC Calculation (Michael algorithm)</div>
    	<table><form id="michael_form" action="calculation/dec/michael.php" method="post">
    ...
    <tr><td>Michael</td><td> = </td><td><input name="mic" id="mic" size="30" value="<?=(isset($_SESSION['demo']['2']['tkip']['michael'])?implode(" ", $_SESSION['demo']['2']['tkip']['michael']):'')?>"/></td></tr></form>
    </table>
    </div>
    <div id="d_after">
    	<table border="2" cellpadding="5" style="border-collapse:collapse;" width="100%">
            					<td align="center" width="100%" height="210px"><p>MAC Header</p>
                                <table border="2" cellpadding="1" width="100%" style="border-collapse:collapse;">
                                            ...
                                            <div id="plaintext" align="justify"><?php if (isset($_SESSION['demo']['tkip']['decrypt'])) echo $_SESSION['demo']['tkip']['decrypt'];?></div>
