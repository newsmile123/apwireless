$("document").ready(function(e) {
	//Инкапсуляция
		var arrowsDrawer2 = $cArrows('#calcs', { render : { strokeStyle: '#949494'}, arrow: {arrowType: 'arrow'}});
		var arrowsDrawer1 = $cArrows('.process', { render : { strokeStyle: '#949494'}, arrow: {arrowType: 'line'}});
			//arrowsDrawer1.arrow('#phase2', '#arrow-iv-packet', { arrow: { connectionType: 'rectangleAngle', angleFrom: 273, angleTo: 226}});
 			arrowsDrawer2.arrow('#phase2', '#encryption', { arrow: { connectionType: 'rectangleAngle', angleFrom: -5, angleTo: 234}});
