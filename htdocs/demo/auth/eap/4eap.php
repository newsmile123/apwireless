...
<body>
<table cellpadding="5" cellspacing="0" width="100%" height="100%" border="1">
	<tr>
	</tr>
    <tr>
		<td valign="top">
		...
		<td align="center" valign="top">
			<table border="1" cellpadding="3" style="border-collapse:collapse;">
  				<tbody style="font-size:12px; font:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;">
        			...
        			<tr>
			  			<td width="400" align="right" valign="top">Для того, чтобы сгенерировать PMK функции PBKDF    требуются: PSK, SSID, длина SSID. Студентам    предлагается получить PMK самостоятельно с помощью калькулятора PBKDF.
          				</td>
      					<td width="200"></td>
  ...
  <tr>
              ...
              <p>PTK = 
                <input name="PMKCheck3" size="64px" value="<?=(isset($_SESSION['ptk'])?$_SESSION['ptk']:'')?>" />
              </td>
      					<td width="200"></td>
        	...
        	<td align="left">Radiotap
            	<table border="1" cellpadding="3" style="border-collapse:collapse;">
                    ...
                    <table border="1" cellpadding="1" style="border-collapse:collapse;">
                        ...
                        <tr><td align="center" colspan="2" width="360px"> Key Recieve Sequence Counter (8 bytes)</td></tr>
                        <tr><td align="center" colspan="2" width="360px"> Key Identifier (8 bytes)</td></tr>
                        <tr><td align="center" colspan="2" width="360px"> Key MIC = <input type="text" id="MIC" name="MIC" size="64px" value="<?=(isset($_SESSION['mic1'])?$_SESSION['mic1']:'')?>"></td></tr>
                        <tr><td align="center" colspan="2" width="360px"> Replay Counter (8 bytes)</td></tr>
                        <tr><td align="center" width="50%"> Key Data Length (2 bytes)</td>
                        	<td align="center" width="50%"> Key Data (2 bytes)</td> </tr>
                    </td>
  ...
  <tr>
			  <td width="400" align="right" valign="top">Устанавливаются ключи. Вычисляется MIC для проверки правильности ANonce полученного в первом шаге.
          </td>
      					<td width="200"></td>
      					<td width="400" valign="top">
                        </td>
        	...
        	<td align="left">Radiotap
            	<table border="1" cellpadding="3" style="border-collapse:collapse;">
                    ...
                    <table border="1" cellpadding="1" style="border-collapse:collapse;">
                        ...
                        <tr><td align="center" colspan="2" width="360px"> Key Recieve Sequence Counter (8 bytes)</td></tr>
                        <tr><td align="center" colspan="2" width="360px"> Key Identifier (8 bytes)</td></tr>
                        <tr><td align="center" colspan="2" width="360px"> Key MIC = <input type="text" id="MIC" name="MIC" size="64px" value="<?=(isset($_SESSION['mic3'])?$_SESSION['mic3']:'')?>"></td></tr>
                        <tr><td align="center" colspan="2" width="360px"> Replay Counter (8 bytes)</td></tr>
                        <tr><td align="center" width="50%"> Key Data Length (2 bytes)</td>
                        	<td align="center" width="50%"> Key Data (2 bytes)</td> </tr>
                    </td>
  ...
  <td></td>
  <td>Устанавливаются ключи.</td></tr>
  <tr>
			  			<td width="400"></td>
      					<td width="200"></td>
      					<td width="400" align="right"><input value='Назад' onclick=location.href='3psk.php' type="button" /><input value='След.' onclick=location.href='../enc/tkipenc.php' type="button" />
                        								</td></tr>
  </table>
  </table>
  </div>
