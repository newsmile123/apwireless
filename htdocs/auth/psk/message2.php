        	...
        	<table border="0" cellpadding="4" style="border-collapse:collapse;">
              ...
              <a href="#" class="showTip ptk">PTK</a> = <input name="ptk2" id="ptk2" size="48px" required="required">
          </td>
      					<td ></td>
        	...
        	<td align="left">Radiotap
            	<table border="1" cellpadding="3" style="border-collapse:collapse;">
                    ...
                    <table border="1" cellpadding="1" style="border-collapse:collapse;">
                        ...
                        <tr><td align="left" colspan="2" width="360px"><a href="#" class="showTip snonce">SNonce</a> = <input name="snonce" id="snonce" size="39px" required="required"></td></tr>
                        ...
                        <tr><td align="left" colspan="2" width="360px">MIC = <input name="mic2" id="mic2" size="40px" required="required"></td></tr>
                        <tr><td align="center" colspan="2" width="360px"> Replay Counter (8 bytes)</td></tr>
  ...
  <td ></td>
                        <td class="leftline"></td>
      					<td class="bottomline">
                        <div id="mess2_hidden">
                        <div id="mess2_success1" align="center">Сообщение успешно передано!</div>
                        	<div id="arrow2">
                            	<div id="left2"></div>
                                <div id="right2"></div>
                            </div>
