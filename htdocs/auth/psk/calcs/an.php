    				...
    				<tr> 
                        ...
                        <table style="border-collapse:collapse;" cellpadding="3" border="0" width="100%" height="250"><tr>
                    		...
                    		<tr height="20">
                    			...
                    			<td align="center"><input name="mac_ap" id="mac" type="text" required="required"/></td></tr>
                            <tr><td align="center" colspan="2" height="40px">
                            <button name="anonce" id="send" title="Считать" onclick="anonce()"/>Считать</button></td></tr>
