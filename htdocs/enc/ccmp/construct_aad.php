  ...
  <div id="aad">
    <div class="description" align="center"><p align="center">Слева перед вами представлен заголовок MAC уровня. Укажите из каких полей заголовка состоят дополнительные аутентификационные данные</p>
    	...
    	<table width="100%" cellpadding="2" style="border-collapse:collapse;" border="2" align="center" >
                                                    <tr>
                                                    <td width="90px"><input id="fc" name="fc" size="12" type="text" value="<?=(isset($_SESSION['aad']['fc'])?$_SESSION['aad']['fc']:'')?>"></input></td>
                                                    <td width="90px"><input id="a1" name="a1" size="12" type="text" value="<?=(isset($_SESSION['aad']['a1'])?$_SESSION['aad']['a1']:'')?>"></input></td>
                                                    <td width="90px"><input id="a2" name="a2" size="12" type="text" value="<?=(isset($_SESSION['aad']['a2'])?$_SESSION['aad']['a2']:'')?>"></input></td>
                                                    <td width="90px"><input id="a3" name="a3" size="12" type="text" value="<?=(isset($_SESSION['aad']['a3'])?$_SESSION['aad']['a3']:'')?>"></input></td>
                                                    <td width="90px"><input id="sc" name="sc" size="12" type="text" value="<?=(isset($_SESSION['aad']['sc'])?$_SESSION['aad']['sc']:'')?>"></input></td>
                                                    <td width="90px"><input id="a4" name="a4" size="12" type="text" value="<?=(isset($_SESSION['aad']['a4'])?$_SESSION['aad']['a4']:'')?>"></input></td>
                                                    <td width="90px"><input id="qos" name="qos" size="12" type="text" value="<?=(isset($_SESSION['aad']['qos'])?$_SESSION['aad']['qos']:'')?>"></input></td>
                                                    </tr>
                                                    			</table>
                                                    			<button id="send" title="Send" onClick="aad()">Переслать</button>
                                                    			
    </div>
    <div id="lab">Ключ для CCM : </div><div id="key" align="left"></div>
</div>
</body>
</html>
