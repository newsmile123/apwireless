...
<div id="encapsulated">
    	<table border="1" cellpadding="5" style="border-collapse:collapse;" width="100%">
            					<td align="center" width="100%"><p>MAC Header</p>
                                            ...
                                            <textarea id="ciphertext" cols="23" rows="12" style="overflow:auto; resize:none;" align="justify"><?php echo @file_get_contents('text/ciphertext-encode.txt'); ?></textarea>
                                            </td></tr>
                                            <tr><td align="center" height="30px"> MIC 8 octets<br /> <div id="code"><?php echo @file_get_contents('text/cbcmac.txt'); ?></div></td></tr>
...
<div id="params">
    ...
    <div id="key">
        <table>
        <tr><td>Key</td><td> = </td><td><input name="cipherkey" id="cipherkey" size="40" value="<?=(isset($_SESSION['ccmp']['dec']['key'])?$_SESSION['ccmp']['dec']['key']:'')?>"/></td></tr></table>
	</div>
	<div id="pn" align="center">
    	<div class="description">
        <table>
           <tr><td>MIC</td><td> = </td><td><div id="mess"></div></td></tr></table>
        </div>
	</div>
    <!--<div id="ccmp-header">
	...
	<div id="before">
    	<table border="2" cellpadding="5" style="border-collapse:collapse;" width="100%">
            					<td align="center" width="100%"><p>MAC Header</p></td></tr>
                                            ...
                                            <textarea id="plaintext" cols="23" rows="12" style="overflow:auto; resize:none;" align="justify"></textarea>
                                            </td></tr>
                                            <tr><td align="center" width="150"> Frame Control Sequence<br /> 4 octets</td></tr></table>
    </div>
</div>
<a href="encapsulation.php" style="float:right; margin-top:50px; margin-right:50px;">Перейти к инкапсуляции</a>
</div>
</body>
</html>