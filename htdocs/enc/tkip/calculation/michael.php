<?php
session_start();
if (isset($_POST['key']) && isset($_POST['sa']) && isset($_POST['da'])){
$mk = $_POST['key'];
$_SESSION['tkip']['sa'] = $_POST['sa'];
$_SESSION['tkip']['da'] = $_POST['da'];
$_SESSION['tkip']['key'] = $_POST['key'];
}
...
$_SESSION['tkip']['michael'] = implode("", str_split($l.$r, 2));
