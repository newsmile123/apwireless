...
$_SESSION["tkip"]['dec']['phase2']["ttak"] = $ttak;
$_SESSION["tkip"]['dec']['phase2']["tk"] = $tk;
$_SESSION["tkip"]['dec']['phase2']["tsc16"] = $tsc16;
...
// Конец шага 3
$_SESSION['tkip']['dec']['phase2']['var'] = "1";
$_SESSION["tkip"]['dec']['phase2']["seed"] = str_replace(" ", "", implode("", $wepSeed));
