<?php
session_start();
if (isset($_POST['michael']) && isset($_POST['sa']) && isset($_POST['da'])){
$mk = $_POST['michael'];
$_SESSION['tkip']['dec']['sa'] = $_POST['sa'];
$_SESSION['tkip']['dec']['da'] = $_POST['da'];
$_SESSION['tkip']['dec']['key'] = $_POST['michael'];
}
...
echo implode("", str_split($l.$r, 2));
$_SESSION['tkip']['dec']['michael'] = implode("", str_split($l.$r, 2));
